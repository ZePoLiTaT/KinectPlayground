...
int main(int argc, char*argv[])
{
  ...
  // mouse observer
  vtkSmartPointer<CommandSubclass3> leftButtonPressCallback = vtkSmartPointer<CommandSubclass3>::New();
  iren->AddObserver(vtkCommand::LeftButtonPressEvent, leftButtonPressCallback);
  ...
  interpolator->GetContourPointIds(rep, ids.GetPointer());
